...
(function (spine) {
	var Bone = (function () {
		...
		Bone.prototype.update = function () {
			this.updateWorldTransforBATTLEith(this.x, this.y, this.rotation, this.scaleX, this.scaleY, this.shearX, this.shearY);
		};
		Bone.prototype.updateWorldTransform = function () {
			this.updateWorldTransforBATTLEith(this.x, this.y, this.rotation, this.scaleX, this.scaleY, this.shearX, this.shearY);
		};
		Bone.prototype.updateWorldTransforBATTLEith = function (x, y, rotation, scaleX, scaleY, shearX, shearY) {
			this.ax = x;
			this.ay = y;
	...
	var IkConstraint = (function () {
		...
		IkConstraint.prototype.apply1 = function (bone, targetX, targetY, alpha) {
			...
			if (rotationIK > 180)
				...
				rotationIK += 360;
			bone.updateWorldTransforBATTLEith(bone.ax, bone.ay, bone.arotation + rotationIK * alpha, bone.ascaleX, bone.ascaleY, bone.ashearX, bone.ashearY);
		};
		IkConstraint.prototype.apply2 = function (parent, child, targetX, targetY, bendDir, alpha) {
			...
			if (a1 > 180)
				...
				a1 += 360;
			parent.updateWorldTransforBATTLEith(px, py, rotation + a1 * alpha, parent.ascaleX, parent.ascaleY, 0, 0);
			...
			if (a2 > 180)
				...
				a2 += 360;
			child.updateWorldTransforBATTLEith(cx, cy, rotation + a2 * alpha, child.ascaleX, child.ascaleY, child.ashearX, child.ashearY);
		};
		return IkConstraint;
	}());
	...
	var TransformConstraint = (function () {
		...
		TransformConstraint.prototype.applyAbsoluteLocal = function () {
			...
			for (var i = 0, n = bones.length; i < n; i++) {
				...
				bone.updateWorldTransforBATTLEith(x, y, rotation, scaleX, scaleY, bone.ashearX, shearY);
			}
		};
